...
?>
<?php echo form_open($this->uri->uri_string(), array('class' =>'form-signin')); echo validation_errors(); ?>

	<div class="form-group">
		<?php echo form_label('Senha anterior', $old_password['id']); ?>
	...
	<button class="btn btn-lg btn-success btn-block" type="submit">Alterar senha</button>
</form>
